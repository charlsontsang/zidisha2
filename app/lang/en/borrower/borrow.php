...
return [
    ...
    'title' => 'Affordable online loans to invest in your future',

    'information-content-part1'     => 'Zidisha is an international lending community that offers high-achieving people the chance to raise affordable online loans. Our website allows you to communicate and raise loans directly from ordinary people all over the world (the lenders).',
    
    'heading2'  => 'Why use Zidisha?',
    
    'paragraph2a'    => 'You may need a loan to grow a business, acquire education or otherwise invest in your future - but local banks charge high interest rates and impose excessive documentation and guarantee requirements.',
     
    'paragraph2b'    => 'We bypass expensive local banks and connect lenders and borrowers directly. The result is a fairly priced loan - and a friendship that transcends geography.',
    
    'advantages'    => 'Zidisha loans offer these advantages:',

    'advantage1'    => 'You do not need to have collateral assets, a bank account, guarantors, or payslips from a salaried job to raise a loan.',
    ...
    application does not guarantee acceptance. If you are approved for membership in Zidisha, you will have access to offer loan funding opportunities to lenders using our website.',
    
    'requirements-content-intro'    => 'In order to apply to join Zidisha, you must:',
...
// How do I Get Started
    ...
    'how-do-content'                => 'Please visit our <a href="/faq#borrower-faqs">Frequently Asked Questions</a> page to learn more.<br/><br/>Ready to apply? Follow the link below to get started.',
