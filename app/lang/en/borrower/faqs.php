...
return [
    ...
    'answer2'              => 'Zidisha is the first-ever online microlending community that directly (!) connects lenders and borrowers — without any intermediaries. Unlike more mainstream microloan websites — like Kiva and MyC4 — that use local intermediary organizations, Zidisha offers a direct person-to-person lending platform. Why is direct better? Because loans managed by local intermediary organizations charge insanely high interest rates (an average of 35%!) to the borrowers to cover their own administrative costs. Zidisha puts 100% of the money lent in the borrowers’ pockets at substantially lower interest rates. We also give lenders and borrowers the opportunity to communicate with each other directly — so you can see everyone’s stories unfold right before your eyes and experience it with them from the other side of the world.',
