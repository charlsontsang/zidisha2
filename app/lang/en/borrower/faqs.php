...
return [
    ...
    'answer2'              => 'Zidisha is the first online microlending community that directly connects lenders and borrowers — without any intermediaries. Unlike more mainstream microloan websites that use local intermediary organizations, Zidisha offers a direct person-to-person lending platform.<br/><br/>Why is direct better? Because loans managed by local intermediary organizations charge high interest rates (an average of 35%!) to the borrowers to cover their own administrative costs.<br/><br/>Zidisha puts 100% of the money lent in the borrowers’ pockets at substantially lower interest rates. We also give lenders and borrowers the opportunity to communicate with each other directly — so you can see everyone’s stories unfold right before your eyes and experience it with them from the other side of the world.',
...
When a loan application is fully funded, the borrower must confirm his or her acceptance of the loan. Once that’s done, we disburse the loan to the borrower in their local currency.',
    ...
    'answer49'             => 'Simply put, we use flat interest rates to make it easy for borrowers and lenders to calculate the interest of their loans. It also helps when comparing Zidisha to other microfinance loans in borrowers\' communities that also use the flat rate interest rates.',
...
So small business owners often protect their households from this risk by maintaining multiple revenue-generating activities at the same time, or by switching quickly from one activity to another in response to changes in the market or other circumstances. For this reason, it is common for Zidisha borrowers to apply for and invest loans in more than one business — and to raise loans totally unrelated to their previous loans if needed.',
    'question63'            => 'What is the difference between flat interest rates and declining balance interest rates?',
    'answer63'              => 'Most people in wealthy countries think of interest rates as an Annual Percentage Rate, or an Annual Effective Rate (APR/AER). In microfinance terms, this is referred to as a "declining balance interest rate." As the loan capital is repaid throughout the life of the loan, the interest charged per month declines accordingly.
                                <br/><br/>
                                ...
                                <br/><br/>
                                The difference is best illustrated with an example:<br/><br/>
