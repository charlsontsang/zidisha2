...
return [
    ...
    'current-limit-title'         => 'Your current credit limit',
    'current-credit-limit'        => 'Your current credit limit is',
    'how-determined'              => 'Here is how that credit limit was determined',
    'insufficient-repayment-rate' => 'Your current on-time repayment rate is :repaymentRate%. In order to qualify for an increase in maximum loan size, you must improve your on-time repayment rate by making future repayment installments on time.  Once your on-time repayment rate for reaches :minRepaymentRate%, you will become eligible for a loan size increase.',
    'first-loan'                  => 'This is the standard credit limit for the first loan raised through Zidisha.',
    'repaid-late'                 => 'You are not eligible for a credit limit increase because your most recent loan was not repaid on time. In order to qualify for an increase in maximum loan size, you must repay your next loan on time while maintaining an on-time repayment rate for of at least :minRepaymentRate%.',
    'insufficient-loan-length'    => 'In order to qualify for an increase in maximum loan size, you must hold the current loan for at least :minLoanLength months and maintain an on-time repayment rate for of at least :minRepaymentRate%.',
    ...
    'sufficient-repayment-rate'   => 'Your current on-time repayment rate is :repaymentRate%. In order to remain eligible for an increase in maximum loan size, you must continue to make at least :minRepaymentRate% of your repayment installments on time.',
    ...
    'how-increase-title'          => 'Credit limit increase criteria',
