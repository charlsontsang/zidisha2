...
class Translator extends NamespacedItemResolver implements TranslatorInterface {
    ...
    public function get($key, array $replace = array(), $locale = null)
    {
        ...
        {
            $this->load($namespace, $folder, $group, $locale);

            $line = $this->getLine(
                $namespace, $folder,  $group, $locale, $item, $replace
            );
     ...
     * @return string|null
     */
    protected function getLine($namespace, $folder,  $group, $locale, $item, array $replace)
    {
     ...
     * @return void
     */
    public function load($namespace, $folder, $group, $locale)
    {
        if ($this->isLoaded($namespace, $folder, $group, $locale)) return;
     ...
     * @return bool
     */
    protected function isLoaded($namespace, $folder, $group, $locale)
    {
        return isset($this->loaded[$namespace][$folder][$group][$locale]);
    }
