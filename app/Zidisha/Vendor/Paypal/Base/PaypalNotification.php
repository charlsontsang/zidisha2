...
abstract class PaypalNotification implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Zidisha\\Vendor\\Paypal\\Map\\PaypalNotificationTableMap';
    ...
    /**
     * Initializes internal state of Zidisha\Vendor\Paypal\Base\PaypalNotification object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Zidisha\\Vendor\\Paypal\\PaypalNotification'), 0, $e);
        }
    }
     ...
     * @return $this|\Zidisha\Vendor\Paypal\PaypalNotification The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Zidisha\Vendor\Paypal\PaypalNotification
     */
     ...
     *
     * @return $this|\Zidisha\Vendor\Paypal\PaypalNotification The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Zidisha\Vendor\Paypal\PaypalNotification (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Zidisha\Vendor\Paypal\PaypalNotification Clone of current object.
     * @throws PropelException
     */
