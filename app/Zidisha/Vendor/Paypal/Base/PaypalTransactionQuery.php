...
abstract class PaypalTransactionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Zidisha\Vendor\Paypal\Base\PaypalTransactionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zidisha', $modelName = '\\Zidisha\\Vendor\\Paypal\\PaypalTransaction', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT ID, TRANSACTION_ID, TRANSACTION_TYPE, AMOUNT, DONATION_AMOUNT, PAYPAL_TRANSACTION_FEE, TOTAL_AMOUNT, STATUS, CUSTOM, CREATED_AT, UPDATED_AT FROM paypal_transactions WHERE ID = :p0';
        try {
