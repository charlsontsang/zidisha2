...
use Zidisha\Vendor\Paypal\PaypalTransaction as ChildPaypalTransaction;
use Zidisha\Vendor\Paypal\PaypalTransactionQuery as ChildPaypalTransactionQuery;
use Zidisha\Vendor\Paypal\Map\PaypalTransactionTableMap;
...
abstract class PaypalTransaction implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Zidisha\\Vendor\\Paypal\\Map\\PaypalTransactionTableMap';
    ...
    /**
     * Initializes internal state of Zidisha\Vendor\Paypal\Base\PaypalTransaction object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : PaypalTransactionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : PaypalTransactionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = PaypalTransactionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Zidisha\\Vendor\\Paypal\\PaypalTransaction'), 0, $e);
        }
    }
     ...
     * @return $this|\Zidisha\Vendor\Paypal\PaypalTransaction The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Zidisha\Vendor\Paypal\PaypalTransaction
     */
     ...
     *
     * @return $this|\Zidisha\Vendor\Paypal\PaypalTransaction The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Zidisha\Vendor\Paypal\PaypalTransaction (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Zidisha\Vendor\Paypal\PaypalTransaction Clone of current object.
     * @throws PropelException
     */
