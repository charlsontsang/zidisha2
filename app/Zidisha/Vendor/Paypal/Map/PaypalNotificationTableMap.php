...
use Zidisha\Vendor\Paypal\PaypalNotification;
use Zidisha\Vendor\Paypal\PaypalNotificationQuery;
...
class PaypalNotificationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Zidisha.Vendor.Paypal.Map.PaypalNotificationTableMap';
     ...
     */
    const OM_CLASS = '\\Zidisha\\Vendor\\Paypal\\PaypalNotification';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Zidisha.Vendor.Paypal.PaypalNotification';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Zidisha\\Vendor\\Paypal\\PaypalNotification');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Zidisha\Vendor\Paypal\PaypalNotification) { // it's a model object
