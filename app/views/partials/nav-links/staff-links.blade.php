<li><a href="https://sites.google.com/a/zidisha.org/zidisha-staff/home">Volunteer Guide</a></li>
<li><a href="http://zidisha.org/forum/categories/volunteer-conversations.26/">Volunteer Forum</a></li>                                   
<li class="@if (Request::segment(2) == 'lenders') active @else '' @endif "><a href="{{ route('admin:lenders') }}">Look Up Lender Account</a></li>
<li class="@if (Request::segment(2) == 'borrowers') active @else '' @endif "><a href="{{ route('admin:borrowers') }}">Look Up Borrower Account</a></li>
<li><a href="#">Reset Passwords</a></li>
<li><a href="{{ route('admin:pending-disbursements') }}">Disburse Loans</a></li>
<li class="@if (Request::segment(2) == 'repayments') active @else '' @endif "><a href="{{ route('admin:repayments') }}">Enter Repayments</a></li>
