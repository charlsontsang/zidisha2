...
<li class="@if (Request::segment(1) == 'dashboard') active @else '' @endif "><a href="{{ route('borrower:dashboard') }}">Dashboard</a></li>
<li><a href="{{ route('loan:index', Auth::getUser()->getBorrower()->getActiveLoanId()) }}">Public Loan Page</a></li>
<li class="@if (Request::segment(1) == 'edit-profile') active @else '' @endif "><a href="{{ route('borrower:edit-profile') }}">Edit Profile</a></li>
<li class="@if (Request::segment(1) == 'invite') active @else '' @endif "><a href="{{ route('borrower:invite') }}">Send Invites</a></li>
<li class="@if (Request::segment(1) == 'invites') active @else '' @endif "><a href="{{ route('borrower:invites') }}">Your Invites</a></li>
<li class="@if (Request::segment(1) == 'credit') active @else '' @endif "><a href="{{ route('borrower:credit') }}">Current Credit</a></li>
<li class="@if (Request::segment(1) == 'history') active @else '' @endif "><a href="{{ route('borrower:history') }}">Payment History</a></li>
